"""Run liorf on the Majang rover configuration (single robot).

Paper dataset configuration ported from commit 0611f71; see
config/majang_rover.yaml for what changed in the port.
"""
...
def generate_launch_description():
    ...
    params = ':'.join([
        os.path.join(share, 'config', 'majang_rover.yaml'),
