"""Run liorf on the STEAM legged platform configuration (single robot).

Paper dataset configuration ported from commit 0611f71; see
config/steam_legged.yaml for what changed in the port.
"""
...
def generate_launch_description():
    ...
    params = ':'.join([
        os.path.join(share, 'config', 'steam_legged.yaml'),
