<div align="center">
  ...
  <p><strong><em>Robust, Lightweight, and Distributed Multi-Robot LiDAR SLAM in Resource-Constrained Field Environments</em></strong></p>
...
## News
* [25.04.29] Our paper was selected for a spotlight talk.
* [25.04.17] Our paper was accepted at the IEEE ICRA 2025 Workshop on Field Robotics.

## Paper
* **Title**: SKiD-SLAM: Robust, Lightweight, and Distributed Multi-Robot LiDAR SLAM in Resource-Constrained Field Environments
* **Authors**: Hogyun Kim, Jiwon Choi, Juwon Kim, Geonmo Yang, Dongjin Cho, Hyungtae Lim, and Younggun Cho
* **Venue**: 2025 IEEE ICRA Workshop on Field Robotics
* **Preprint**: [arXiv:2505.08230v3](https://arxiv.org/abs/2505.08230)
